    ...
    <div class="card-box mb-30">
        <div class="pd-20">
            <h4 class="text-blue h4">All Employees
                <a href="{{ route('addEmployee') }}" style="float: right" class="btn btn-outline-primary">
                    <i class="icon-copy dw dw-add"></i> Add Employee
                </a>
            </h4>
        </div>
        <div class="pb-20">
                        ...
                        <td>
							<div class="dropdown">
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
									...
									<a class="dropdown-item deleteEmployee" id="{{ $employee->id }}" value="{{ $employee->getFullName() }}"><i class="dw dw-delete-3"></i> Delete</a>
								</div>
							</div>
						</td>
					</tr>
