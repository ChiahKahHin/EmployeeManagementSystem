...
@section('pageTitle')
	Task Analytics {{ (Auth::user()->isAccess('hrmanager', 'manager')) ? "(Manager)" : null }}
@endsection
		...
		<div class="row">
			<div class="col-xl-12 mb-30">
				<div class="card-box height-100-p pd-20">
					<h2 class="h4 mb-30">Overall Task
						@if (Auth::user()->isAccess('hrmanager', 'manager'))
							<a href="{{ route('taskAnalyticsPage3') }}" style="float: right" class="btn btn-outline-primary">
