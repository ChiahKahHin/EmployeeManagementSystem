        ...
        <form action="{{ route('addEmployee') }}" method="POST">
            ...
            <div class="form-group">
                <div class="row">
					...
					<div class="col-md-6">
						<label>Address</label>
						<textarea class="form-control @error('address') form-control-danger @enderror" id="address" name="address" style="min-height:50px; max-height:150px; height:45px; resize: vertical;" placeholder="Enter address" maxlength="255" onkeyup="countWords()" data-gramm_editor="false">{{ old('address') }}</textarea>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label>Email</label>
                        <input class="form-control @error('email') form-control-danger @enderror" type="email" name="email" autocomplete="off" placeholder="Enter email address (e.g. employee@gmail.com)" value="{{ old('email') }}">
