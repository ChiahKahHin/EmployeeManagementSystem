			...
			<div class="form-group">
                <div class="row">
					<div class="col-md-6">
						...
						<input class="form-control @error('ic') form-control-danger @enderror" type="text" name="ic" placeholder="Enter NRIC/Passport No" value="{{ old('ic', $employees->getEmployeeInfo->ic) }}" required>
