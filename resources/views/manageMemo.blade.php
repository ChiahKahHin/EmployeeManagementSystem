...
@section('content')
	<div class="card-box mb-30">
		<div class="pd-20">
			<h4 class="text-blue h4">All Memorandum
				<a href="{{ route('createMemo') }}" style="float: right" class="btn btn-outline-primary">
                    <i class="icon-copy dw dw-add"></i> Create Memorandum
                </a>
			</h4>
		</div>
		<div class="pb-20">
